...
static const char *fonts[]          = { "Liberation Mono:size=12" , "FontAwesome:size=10"};
...
static const char *blankcmd[]  = { "xscreensaver-command", "-activate", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask|ControlMask, XK_l,      spawn,          {.v = blankcmd } },
